...
This repository is an **independent, unofficial study aid** created by a candidate preparing for the IAPP AIGP (Artificial Intelligence Governance Professional) certification exam. It is:

- **Not affiliated with, endorsed by, sponsored by, or produced in partnership with** the International Association of Privacy Professionals (IAPP) or John Wiley & Sons, Inc.
- **Not a substitute for** IAPP's official Body of Knowledge, training, or practice exam. Where this kit's content differs from IAPP's official materials, the official materials govern.
- **Provided "as is,"** with no warranty of accuracy, completeness, or exam relevance. It may contain errors. Passing the AIGP exam is not guaranteed by using it.

## Trademarks

AIGP®, IAPP®, CIPP®, CIPM®, and CIPT® are registered trademarks of the International Association of Privacy Professionals. They are used here only to accurately describe the exam this kit helps candidates prepare for (nominative use), not to claim any affiliation or endorsement.
